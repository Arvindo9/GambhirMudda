...
import com.jithvar.gambhirmudda.photodraweeview.OnPhotoTapListener;
import com.jithvar.gambhirmudda.photodraweeview.OnViewTapListener;
import com.jithvar.gambhirmudda.photodraweeview.PhotoDraweeView;
...
import static com.jithvar.gambhirmudda.constant.Config.OUTPUT_IMAGE_FOLDER;
...
//                File outPut = new File(Environment.getExternalStorageDirectory(), params[1]);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                Toast.makeText(ImageDisplay.this, getResources().getString(R.string
                        .file_downloaded), Toast
                        .LENGTH_SHORT).show();
        }
